# Graph Report - causalyst  (2026-08-10)

## Corpus Check
- 20 files · ~21,222 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 130 nodes · 227 edges · 15 communities (12 shown, 3 thin omitted)
...
5. `granger_edges()` - 8 edges
6. `clean_error()` - 8 edges
...
- **Why does `granger_edges()` connect `run_clustering.py` to `MarketGraph`, `real_data_experiment.py`, `gnn_prototype.py`?**
